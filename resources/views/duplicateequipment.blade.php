    ...
    <div class="container mb-5">
        <div class="row justify-content-md-center mt-3">
            ...
            <div class="col-lg-6">
                ...
                @endif
                <form method="POST" action="{{ route('equipment.storeCopy', $equipment->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary mb-3">Dupliquer</button>
                </form>
            </div>
            <div class="col col-lg-3">
            </div>
