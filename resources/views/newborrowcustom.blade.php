                ...
                <form method="POST" action="{{ route('borrow.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <input name='equipment_id' class="form-control @error('equipment_id') is-invalid @enderror" id="equipment_id" value="{{ $equipment->id }}" readonly>
                            </div>
                            <div class="col-5">
                                <label for="equipment_id"><i>{{ $equipment->name }}</i></label>
                            </div>
                        </div>
                        @error('equipment_id')
                        <div class="alert alert-danger mt-2">
