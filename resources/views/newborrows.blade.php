    ...
    <div class="container mb-5">
        <div class="row justify-content-md-center mt-3">
            ...
            <div class="col-lg-5">
                ...
                @endif
                <form method="POST" action="{{ route('borrow.storemany') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="equipment_code">Equipements <br/> <small>Mettre les numéros des objets (code) séparés par une ",". Ne pas mettre de virgule après le dernier code </small></label>
                        <input name='equipment_code' type="text" class="form-control @error('equipment_code') is-invalid @enderror" id="equipment_code" placeholder="100089,100102" required>
...
@section('additionnalScript')
    ...
    <script>
        $('.datepicker').pickadate({
            format: 'yyyy-mm-dd',
            clear: '',
            /*disable after deciding that students working for the cse can make borrow every day*/
            /*disable: [
                1, 3, 5, 6, 7
            ],*/
        });
